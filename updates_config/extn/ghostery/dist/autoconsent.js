typeof browser<"u"&&(chrome=browser),(()=>{var N1={86782:(I,v,s)=>{var e={"./card.js":43730,"./header.js":58489};function i(V){var g=m(V);return s(g)}function m(V){if(!s.o(e,V)){var g=new Error("Cannot find module '"+V+"'");throw g.code="MODULE_NOT_FOUND",g}return e[V]}i.keys=function(){return Object.keys(e)},i.resolve=m,I.exports=i,i.id=86782},72782:(I,v,s)=>{var e={"./confirm.js":44915,"./home.js":18589,"./main.js":57269};function i(V){var g=m(V);return s(g)}function m(V){if(!s.o(e,V)){var g=new Error("Cannot find module '"+V+"'");throw g.code="MODULE_NOT_FOUND",g}return e[V]}i.keys=function(){return Object.keys(e)},i.resolve=m,I.exports=i,i.id=72782},23998:(I,v,s)=>{var e={"./action.js":49111,"./button.js":69092,"./icon.js":29810,"./line.js":38191,"./onboarding-state.js":62788,"./text.js":86561,"./tooltip.js":89247,"./tracker-wheel.js":62254};function i(V){var g=m(V);return s(g)}function m(V){if(!s.o(e,V)){var g=new Error("Cannot find module '"+V+"'");throw g.code="MODULE_NOT_FOUND",g}return e[V]}i.keys=function(){return Object.keys(e)},i.resolve=m,I.exports=i,i.id=23998},43730:(I,v,s)=>{"use strict";s.r(v),s.d(v,{default:()=>i});var e=s(56400);const i={render:()=>e.dy`
    ...
    `}},58489:(I,v,s)=>{"use strict";s.r(v),s.d(v,{default:()=>i});var e=s(56400);const i={render:()=>e.dy`
  ...
  `}},44915:(I,v,s)=>{"use strict";s.r(v),s.d(v,{default:()=>N});var e=s(77540),i=s(56400),m=s(67132),V=s(9300);function g(x){(0,e.WI)(x,"closeiframe",{bubbles:!0,detail:{reload:x.enabled}})}const N={enabled:!1,content:({enabled:x})=>i.dy`
    <template layout="column margin:3 gap:4">
      <div layout="column items:center gap margin:0:5">
        <ui-text type="display-s" layout="block:center">
          ${x?m.WI`Never-Consent is Enabled`:m.WI`Never-Consent is Disabled`}
        </ui-text>
        <ui-text layout="block:center">
          ${m.WI.html`You can always change these settings in the&nbsp;<strong>Ghostery control panel</strong>.`}
        </ui-text>
      </div>
      <div layout="grid:2 gap:2">
        <ui-button type="outline" size="small">
          <a href="${V.Z.backUrl()}">Back</a>
        </ui-button>
  ...
  `}},18589:(I,v,s)=>{"use strict";s.r(v),s.d(v,{default:()=>x});var e=s(77540),i=s(9300),m=s(56400),V=s(44915);const g=new URLSearchParams(window.location.search).get("default");function N(H){return L=>{(0,e.WI)(L,H,{bubbles:!0,detail:{all:L.scope==="all"}})}}const x={[i.Z.connect]:{stack:[V.default]},scope:g==="all"?"all":"selected",content:({scope:H})=>m.dy`
    <template layout="column margin:3 gap:4">
      ...
      <div layout="grid:2 gap:2">
        <ui-button type="outline" size="small">
          <a
            href="${i.Z.url(V.default,{enabled:!1})}"
            onclick="${N("disable")}"
          >
            No
          </a>
        ...
        <ui-button type="primary" size="small">
          <a
            href="${i.Z.url(V.default,{enabled:!0})}"
            onclick="${N("enable")}"
          >
            Yes
          </a>
  ...
  `}},57269:(I,v,s)=>{"use strict";s.r(v),s.d(v,{default:()=>x});var e=s(77540),i=s(9300),m=s(56400),V=s(67132),g=s(18589);function N(H,L){(0,e.WI)(H,"close",{detail:{reload:L.detail.reload}}),H.parentElement.removeChild(H)}const x={tag:"ui-autoconsent",stack:(0,i.Z)([g.default]),categories:{get:(H,L=[])=>L,set:(H,L)=>L||[]},content:({stack:H,categories:L})=>m.dy`
    <template layout="grid::min|1|min">
      <ui-autoconsent-card oncloseiframe="${N}">
        <ui-autoconsent-header></ui-autoconsent-header>
        ${H}
      </ui-autoconsent-card>
      ${i.Z.active(g.default)&&m.dy`
          ...
          <section layout="row margin:2 gap:2">
            ...
            <div layout="column grow shrink gap">
              <ui-text type="label-m">
                ${V.WI.html`Trackers detected by Ghostery on this
                website:&nbsp;${L.length}`}
              </ui-text>
              <ui-text type="body-s">
  ...
  `}},49111:(I,v,s)=>{"use strict";s.r(v),s.d(v,{default:()=>i});var e=s(56400);const i={render:()=>e.dy`
  ...
  `}},69092:(I,v,s)=>{"use strict";s.r(v),s.d(v,{default:()=>i});var e=s(56400);const i={type:"primary",size:"",disabled:!1,render:({size:m})=>e.dy`<slot></slot>`.css`
      :host {
        ...
        white-space: nowrap;
        transition: opacity 0.2s, color 0.2s, background-color 0.2s, border-color 0.2s;
        font: var(--ui-font-button-${m==="small"?"s":"m"});
   ...
   `}},29810:(I,v,s)=>{"use strict";s.r(v),s.d(v,{default:()=>i});var e=s(56400);const i={name:"",color:"",render:({name:V,color:g})=>e.dy`
    <template layout="block">${m[V]||""}</template>
  `.css`
    :host {
      ${g?`color: var(--ui-color-${g});`:""}
    }
  ...
  `}},38191:(I,v,s)=>{"use strict";s.r(v),s.d(v,{default:()=>i});var e=s(56400);const i={color:"gray-200",render:({color:m})=>e.dy`
    <template layout="block height:1px shrink:0"></template>
  `.css`
    :host {
      background: var(--ui-color-${m});
    }
  `}},62788:(I,v,s)=>{"use strict";s.r(v),s.d(v,{default:()=>i});var e=s(56400);const i={disabled:!1,href:"",render:({disabled:m,href:V})=>e.dy`
    <template
    ...
    >
      ${m&&e.dy`
        ...
        >
          ...
          <a layout="absolute inset layer:3" href="${V}" target="_blank"></a>
        </section>
      `}
  ...
  `}},86561:(I,v,s)=>{"use strict";s.r(v),s.d(v,{default:()=>i});var e=s(56400);const i={type:"body-m",mobileType:"",color:"",ellipsis:!1,underline:!1,render:({type:m,mobileType:V,color:g})=>e.dy`<slot></slot>`.css`
    :host {
      display: block;
      font: var(--ui-font-${V||m});
      color: var(--ui-text-color, inherit);
    }

    ${V?`
          @media screen and (min-width: 768px) {
            :host { font: var(--ui-font-${m}); }
          }
        `:""}
    ...
    :host([color]) {
      --ui-text-color: var(--ui-color-${g});
      --ui-text-color-anchor: var(--ui-color-${g});
      --ui-text-color-heading: var(--ui-color-${g});
    }
  ...
  `}},89247:(I,v,s)=>{"use strict";s.r(v),s.d(v,{default:()=>V});var e=s(56400);const i=new WeakMap;let m=null;const V={autohide:2,wrap:!1,show:{value:!1,connect:g=>()=>clearTimeout(i.get(g)),observe:(g,N)=>{const x=g.render().querySelector("#tooltip");if(x.hidden=!N,x.style.transform="",N){m&&m!==g&&(m.show=!1),m=g;const{left:H,width:L}=x.getBoundingClientRect(),k=H+L+8-window.innerWidth,A=H-8;k>0?x.style.transform=`translateX(calc(-50% - ${k}px)`:A<0&&(x.style.transform=`translateX(calc(-50% + ${Math.abs(A)}px)`),g.autohide&&i.set(g,setTimeout(()=>{g.show=!1},g.autohide*1e3))}else clearTimeout(i.get(g))}},render:()=>e.dy`
    <template layout="contents">
      <div
  ...
  `}},62254:(I,v,s)=>{"use strict";s.r(v),s.d(v,{default:()=>N});var e=s(56400),i=s(4182),m=s(56570);function V(x,H){const{clientX:L,clientY:k}=H,{left:A,top:i1}=x.getBoundingClientRect(),l1=L-A,t1=k-i1;x.tooltip.style.left=`${l1}px`,x.tooltip.style.top=`${t1}px`}function g(x){return(H,L)=>L===x?H+1:H}const N={categories:void 0,data:({categories:x=[]})=>{if(!x.length)return[["",{value:100,offset:0}]];const H=x.reduce((t1,h1)=>{const O=t1.get(h1)||0;return t1.set(h1,O+1),t1},new Map);let L=x.length;const k=4,A=[];H.forEach((t1,h1)=>{t1/L<=k/100&&A.push(h1)});const i1=L/(100/k-A.length);A.forEach(t1=>{const h1=H.get(t1);H.set(t1,i1),L+=i1-h1});let l1=0;return H.forEach((t1,h1)=>{t1=Math.max(t1/L*100-k,0),H.set(h1,{value:t1,offset:l1}),l1+=(t1+k)*360/100}),[...H.entries()]},current:"",tooltip:({render:x})=>x().querySelector("ui-tooltip"),render:({categories:x,data:H,current:L})=>e.dy`
    <template layout="grid relative">
      ...
      <svg viewBox="0 0 36 36" onmousemove="${V}">
        ${H.map(([k,{value:A,offset:i1}])=>e.YP`
              <path
                class="${{empty:!k}}"
                stroke-dasharray="${A}, ${100-A}"
                transform="rotate(${i1}, 18, 18)"
                stroke="${(0,i.W9)(k)}"
                d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"
                onmouseenter="${e.dy.set("current",k)}"
  ...
  `.css`
   ...
   `}},9664:(I,v,s)=>{"use strict";var e=s(67132);typeof chrome=="object"&&chrome.i18n&&(0,e.NC)(chrome.i18n.getMessage.bind(chrome.i18n),{format:"chrome.i18n"})},4182:(I,v,s)=>{"use strict";s.d(v,{W9:()=>V});const e={advertising:" #CB55CD",site_analytics:"#87D7EF",consent:"#556FCD",essential:"#FC9734",hosting:"#8459A5",customer_interaction:"#EF671E",unidentified:"#E8E8E8",audio_video_player:"#4ECB4E",cdn:"#4ECBA1",comments:"#4EA1CB",email:"#4E4ECB",extensions:"#A14ECB",misc:"#CB4EA1",pornvertising:"#CB4E4E",social_media:"#CBA14E",telemetry:"#A1CB4E"},i=null,m=N=>e[N]?N:"unidentified",V=N=>e[m(N)],g=(N=x=>x)=>(x,H)=>{const L=m(N(x)),k=m(N(H));return i.indexOf(L)-i.indexOf(k)}},56570:(I,v,s)=>{"use strict";s.d(v,{b:()=>m});var e=s(67132),i=s(9664);const m={advertising:e.WI`Advertising | Tracker category name`,site_analytics:e.WI`Site Analytics | Tracker category name`,consent:e.WI`Consent Management | Tracker category name - includes trackers used for cookie consent management, allowing websites different levels of tracking user activity`,essential:e.WI`Essential | Tracker category name`,hosting:e.WI`Hosting | Tracker category name`,customer_interaction:e.WI`Customer Interaction | Tracker category name`,unidentified:e.WI`Unidentified | Tracker category name`,audio_video_player:e.WI`Audio/Video Player | Tracker category name`,cdn:e.WI`CDN | Tracker category name`,comments:e.WI`Comments | Tracker category name`,email:e.WI`Email | Tracker category name`,extensions:e.WI`Extensions | Tracker category name`,misc:e.WI`Miscellaneous | Tracker category name`,pornvertising:e.WI`Adult Advertising | Tracker category name`,social_media:e.WI`Social Media | Tracker category name`,telemetry:e.WI`Telemetry | Tracker category name`}},96806:(I,v,s)=>{"use strict";s.d(v,{N7:()=>k,NE:()=>h1,U2:()=>H,t8:()=>L,z6:()=>t1});var e=s(17337);const i=new WeakMap,m=new Set;function V(O){const K=new Set,y=K.values();for(;O;){if(O.resolved=!1,O.deps){for(const b of O.deps)b.contexts.delete(O);O.deps.clear()}if(O.contexts)for(const b of O.contexts)m.has(b)||(K.add(b),O.contexts.delete(b));O.observe&&e.I(O.observe),O=y.next().value}}function g(O,K){let y=i.get(O);y||(y=new Map,i.set(O,y));let b=y.get(K);return b||(b={key:K,target:O,value:void 0,lastValue:void 0,resolved:!1,contexts:void 0,deps:void 0,observe:void 0},y.set(K,b)),b}function N(O){const K=i.get(O);return K?[...K.values()]:[]}let x=null;function H(O,K,y){const b=g(O,K);if(x&&(b.contexts||(b.contexts=new Set),x.deps||(x.deps=new Set),b.contexts.add(x),x.deps.add(b)),b.resolved)return b.value;const z=x;try{if(m.has(b))throw Error(`Circular get invocation is forbidden: '${K}'`);x=b,m.add(b),b.value=y(O,b.value),b.resolved=!0,x=z,m.delete(b)}catch(Q){throw x=z,m.delete(b),x&&(x.deps.delete(b),b.contexts.delete(x)),Q}return b.value}function L(O,K,y,b){const z=g(O,K),Q=y(O,b,z.value);Q!==z.value&&(z.value=Q,V(z))}function k(O,K,y,b){const z=g(O,K);return z.observe=()=>{const Q=H(O,K,y);Q!==z.lastValue&&(b(O,Q,z.lastValue),z.lastValue=Q)},e.I(z.observe),()=>{e.Z(z.observe),z.observe=void 0,z.lastValue=void 0}}const A=new Set;function i1(O){A.size||setTimeout(()=>{for(const K of A)if(!K.contexts||K.contexts.size===0){if(K.deps)for(const b of K.deps)b.contexts.delete(K);i.get(K.target).delete(K.key)}A.clear()}),A.add(O)}function l1(O,K){V(O),K.clearValue&&(O.value=void 0,O.lastValue=void 0),K.deleteEntry&&i1(O)}function t1(O,K,y={}){const b=g(O,K);l1(b,y)}function h1(O,K={}){const y=i.get(O);if(y)for(const b of y.values())l1(b,K)}},17337:(I,v,s)=>{"use strict";s.d(v,{I:()=>m,Z:()=>V});var e=s(77540);const i=new Set;function m(N){i.size||e.gX.then(g),i.add(N)}function V(N){i.delete(N)}function g(){for(const N of i)try{N()}catch(x){console.error(x)}i.clear()}},80004:(I,v,s)=>{"use strict";s.d(v,{Z:()=>i});function e(m){return m=Object.create(m),"HTMLElement"in m||Object.defineProperty(m,"HTMLElement",{value:class{constructor(){throw Error("Current context does not support defining custom elements")}}}),"document"in m||Object.defineProperty(m,"document",{value:{importNode:()=>{throw Error("Current context does not support importing nodes")}}}),m}const i=typeof window=="object"?window:e(globalThis)},67132:(I,v,s)=>{"use strict";s.d(v,{NC:()=>t1,U2:()=>i1,WI:()=>K,eL:()=>L});var e=s(58768),i=s(80004),m=s(77540),V=s(56400);const g=new Map,N=new Map;let x=null;const H=(()=>{let y;try{y=i.Z.navigator.languages||[i.Z.navigator.language]}catch{y=[]}return y.reduce((b,z)=>{const Q=z.split("-")[0];return b.add(z),z!==Q&&b.add(Q),b},new Set)})();function L(){return x!==null||g.size}function k(){H.delete("default"),g.clear(),N.clear(),x=null}const A=new Map;function i1(y,b,z=[]){y=y.trim().replace(/\s+/g," "),b=b.trim();const Q=`${y} | ${b}`;let J=N.get(Q);if(!J){if(g.size)for(const d1 of H){const C1=g.get(d1);if(C1&&(J=C1[Q]||C1[y],J)){if(J=J.message,typeof J=="object"){let a1=A.get(d1);a1||(a1=new Intl.PluralRules(d1),A.set(d1,a1));const w=J;J=f=>f===0&&w.zero||w[a1.select(f)]||w.other||""}break}}J||(x&&(J=x(y,b)),J||(J=y,(g.size||x)&&m.$H&&console.warn(`Missing translation: "${y}"${b?` [${b}]`:""}`))),N.set(Q,J)}return typeof J=="function"?J(z[0]):J}function l1(y){return y.replace("$","@").replace(/[^a-zA-Z0-9_@]/g,"_").toLowerCase()}function t1(y,b){switch(typeof y){case"function":{if((b||{}).format==="chrome.i18n"){const Q=new Map;x=(J,d1)=>{J=d1?`${J} | ${d1}`:J;let C1=Q.get(J);return C1||(C1=l1(J),Q.set(J,C1)),y(C1,d1)}}else x=y;break}case"string":{if(!b||typeof b!="object")throw TypeError("Messages must be an object");y==="default"&&H.add("default");const z=g.get(y)||{};g.set(y,{...z,...b});break}default:throw TypeError("The first argument must be a string or a function")}}Object.defineProperty(t1,"languages",{get:()=>Array.from(H)});function h1(y,b){let z="";for(const[d1,C1]of y.entries())z+=d1?`\${${d1-1}}${C1}`:C1;const[Q,,J=""]=z.split("|");return i1(Q,J,b)}const O=/\$\{(\d+)\}/g;function K(y,...b){return h1(y,b).replace(O,(z,Q)=>b[Q])}K.html=function(b,...z){const Q=h1(b,z);return(0,V.MY)(Q.replace(O,(J,d1)=>(0,e.ph)(d1)),z,!1,!0)},K.svg=function(b,...z){const Q=h1(b,z);return(0,V.MY)(Q.replace(O,(J,d1)=>(0,e.ph)(d1)),z,!0,!0)}},9300:(I,v,s)=>{"use strict";s.d(v,{Z:()=>B1});var e=s(80004),i=s(96806),m=s(77540);const V=Symbol("router.connect"),g=new WeakMap,N=new WeakMap,x=new WeakMap,H=new WeakMap;let L=null;const k=new Set;let A=!1;function i1(r=!0){A=!!r}const l1=new WeakMap,t1=new WeakMap;function h1(r){const C=e.Z.document.activeElement;t1.set(r,L.contains(C)&&C);const a=new Map;for(const d of[e.Z.document.documentElement,e.Z.document.body])a.set(d,{left:d.scrollLeft,top:d.scrollTop});(0,m.N7)(r,d=>{(d.scrollLeft||d.scrollTop)&&a.set(d,{left:d.scrollLeft,top:d.scrollTop})}),l1.set(r,a)}function O(r){if(r.tabIndex===-1){const C=r.style.outline;r.tabIndex=0,r.style.outline="none",r.addEventListener("blur",()=>{r.removeAttribute("tabindex"),r.style.outline=C},{once:!0})}r.focus({preventScroll:!0})}function K(r){const C=e.Z.document.activeElement;m.gX.then(()=>{O(t1.get(r)||(L.contains(C)?C:L));const a=l1.get(r);if(a){const d=g.get(r),u=e.Z.history.state.find(j=>j.id===d.id),$=u&&u.params.scrollToTop;for(const[j,{left:P,top:B}]of a)j.scrollLeft=$?0:P,j.scrollTop=$?0:B;l1.delete(r)}else for(const d of[e.Z.document.documentElement,e.Z.document.body])d.scrollLeft=0,d.scrollTop=0;setTimeout(()=>{e.Z.history.scrollRestoration="auto"},0)})}function y(r){return r===!0?1:r||""}const b=["scrollToTop"];function z(r,C){const[a,d=""]=r.split("?"),_=d?d.split(","):[],u=a.replace(/^\//,"").split("/"),$=u.reduce((j,P)=>{if(P.startsWith(":")){const B=P.slice(1);if(_.includes(B))throw Error(`The '${B}' already used in search params`);if(j.includes(B))throw Error(`The '${B}' already used in pathname`);j.push(B)}return j},[]);return{browserUrl:r,pathnameParams:$,paramsKeys:[..._,...$],url(j,P=!1){let B="";for(let W of u){if(W.startsWith(":")){const F=W.slice(1);if(!hasOwnProperty.call(j,F))throw Error(`The '${F}' parameter must be defined for <${C}>`);W=y(j[F])}B+=`/${W}`}const R=new URL(B,e.Z.location.origin);for(const W of Object.keys(j))$.includes(W)||P&&(b.includes(W)||!_.includes(W))||R.searchParams.append(W,y(j[W]));return R},match(j){const P={},B=j.pathname.replace(/^\//,"").split("/");if(B.length!==u.length)return null;for(let R=0;R<B.length;R+=1){const W=B[R],F=u[R];if(F.startsWith(":")){const p1=F.slice(1);P[p1]=W}else if(W!==F)return null}for(const[R,W]of j.searchParams)P[R]=W;return P}}}function Q(r,C){return r.stack.some(a=>a===C?!0:Q(a,C))}function J(r){r.browserUrl&&k.add(r);for(const C of r.stack)J(C)}function d1(r,C,a=null,d=null){return typeof r=="function"&&(r=r()),r=[].concat(r),r.map(_=>{const u=g.get(_);if(u&&Q(u,a))throw Error(`<${u.id}> cannot be in the stack of <${a.id}>, as it is an ancestor in the stack tree`);return w(_,C,a,d)})}function C1(r,C){const a=Object.values(r).map(d=>H.get(d)).filter(d=>d);if(a.length){if(a.length>1)throw TypeError(`<${C.id}> must contain at most one nested router, found: ${a.length}`);if(C.dialog)throw TypeError(`Nested routers are not supported in dialogs. Remove the router property definition from <${C.id}>`);if(C.browserUrl)throw TypeError(`A view with nested router must not have the url option. Remove the url option from <${C.id}>`)}return a[0]}function a1(r){const C=e.Z.customElements.get(r);return g.get(C)}function w(r,C,a,d){const _=r.tag;let u=a1(_);if(u&&u.hybrids!==r&&(u=null),u)u.parent=a,u.nestedParent=d;else{const j=e.Z.customElements.get(_);if(!j||j.hybrids!==r)throw Error(`<${_}> view must be defined by 'define()' function before it can be used in router factory`);let P=null;const B={dialog:!1,guard:!1,multiple:!1,replace:!1,...r[V]},{connects:R}=j;B.dialog&&R.add(D=>{const n1=t=>{t.key==="Escape"&&(t.stopPropagation(),e.Z.history.go(-1))},r1=t=>{!D.contains(t.target)&&t.target!==D&&O(D)},o=L;return o.addEventListener("focusin",r1),o.addEventListener("focusout",r1),D.addEventListener("keydown",n1),O(D),()=>{o.removeEventListener("focusin",r1),o.removeEventListener("focusout",r1),D.removeEventListener("keydown",n1)}});const W=[];for(const D of Object.keys(j.prototype))Object.getOwnPropertyDescriptor(j.prototype,D).set&&W.push(D);if(B.url){if(B.dialog)throw Error(`The 'url' option is not supported for dialogs - remove it from <${_}>`);if(typeof B.url!="string")throw TypeError(`The 'url' option in <${_}> must be a string: ${typeof B.url}`);P=z(B.url,_);for(const D of P.paramsKeys){const n1=Object.getOwnPropertyDescriptor(j.prototype,D);if(!n1||!n1.set)throw Error(`'${D}' parameter from the url is not ${n1?"writable":"defined"} in <${_}>`)}}const F=W.filter(D=>!C.params.includes(D)&&!b.includes(D)),p1=P?F.filter(D=>!P.pathnameParams.includes(D)):F;R.add(D=>i.N7(D,V,n1=>{const r1={};for(const o of F){const t=y(n1[o]).toString();r1[o]=t!==void 0&&n1[o]!==r[o]?String(t):void 0}return r1},(n1,r1,o)=>{if(!o)return;const t=e.Z.history.state;let n=t[0];for(;n.id!==_&&n.nested;)n=n.nested;r1={...n.params,...r1};for(const l of p1)r1[l]===void 0&&delete r1[l];e.Z.history.replaceState([u.getEntry(r1),...t.slice(1)],"",P?u.url(r1,!0):"")}));let M1;if(B.guard&&(M1=()=>{try{return B.guard()}catch(D){return console.error(D),!1}}),u={id:_,hybrids:r,dialog:B.dialog,multiple:B.multiple,replace:B.replace,guard:M1,parent:a,nestedParent:d,nestedRoots:void 0,parentsWithGuards:void 0,stack:[],...P||{url(D){const n1=new URL("",e.Z.location.origin);for(const r1 of Object.keys(D))n1.searchParams.append(r1,y(D[r1]));return new URL(`${C.url}#@${_}${n1.search}`,e.Z.location.origin)},match(D){const n1={};for(const[r1,o]of D.searchParams)(W.includes(r1)||b.includes(r1))&&(n1[r1]=o);return n1}},create(){const D=new j;return g.set(D,u),D},getEntry(D={},n1){let r1={};for(const n of Object.keys(D))W.includes(n)&&(r1[n]=D[n]);const o={id:_,params:r1,...n1},t=u.parentsWithGuards.find(n=>!n.guard());if(t)return t.getEntry(D,{from:o});if(u.guard&&u.guard())return{...u.stack[0].getEntry(D)};if(u.nestedParent)return u.nestedParent.getEntry(D,{nested:o});for(const n of b)hasOwnProperty.call(D,n)&&(o.params[n]=D[n]);return o}},g.set(r,u),g.set(j,u),a&&!a.stack.includes(u)&&a.stack.push(u),B.stack){if(B.dialog)throw Error(`The 'stack' option is not supported for dialogs - remove it from <${_}>`);d1(B.stack,C,u,d)}}for(a||J(u),u.parentsWithGuards=[];a;)a.guard&&u.parentsWithGuards.unshift(a),a=a.parent;const $=C1(r,u);return $&&(u.nestedRoots=d1($.views,{...C,...$},u,u),u.stack=u.stack.concat(u.nestedRoots)),u}function f(r,C={}){const a=g.get(r);return a?a.url(C):""}function Z(r){const C={};for(;r;)Object.assign(C,r.params),r=r.nested;return C}function E({nested:r=!1,scrollToTop:C=!1}={}){const a=e.Z.history.state;if(!a)return"";if(a.length>1){const u=a[0];let $=1,j=a[$];if(r)for(;j.nested;)j=j.nested;else for(;u.id===j.id&&$<a.length-1;)$+=1,j=a[$];const P=Z(a[$]);return C?P.scrollToTop=!0:delete P.scrollToTop,a1(j.id).url(P)}let d=a[0];if(r)for(;d.nested;)d=d.nested;let _=a1(d.id).parent;if(_){for(;_&&_.guard;)_=_.parent;if(_)return _.url(Z(a[0]))}return""}function c(r={}){const C=e.Z.history.state;if(!C)return"";const a=C[0];if(a.from)return a1(a.from.id).url({...a.from.params,...r});const d=a1(a.id);return d.stack[0]?d.stack[0].url(r):""}function p(r){const C=e.Z.history.state;if(!C)return"";let a=C[0];for(;a.nested;)a=a.nested;return a1(a.id).url({...a.params,...r})}function o1(r,{stack:C=!1}={}){const a=e.Z.history.state;return a?(r=[].concat(r),r.some(d=>{const _=g.get(d);if(!_)throw TypeError(`Provided view is not connected to the router: ${d}`);let u=a[0];for(;u;){const $=a1(u.id);if($===_||C&&Q(_,$))return!0;u=u.nested}return!1})):!1}function q(r){let C;const[a,d]=r.hash.split("?");if(a&&a.match(/^#@.+-.+/)&&(C=a1(a.split("@")[1]),r=new URL(`?${d}`,e.Z.location.origin)),!C){for(const _ of k){const u=_.match(r);if(u)return _.getEntry(u)}return null}return C.getEntry(C.match(r))}function c1(r){if(r.defaultPrevented)return;let C;if(r.type==="click"){if(r.ctrlKey||r.metaKey)return;const a=r.composedPath().find(d=>d instanceof e.Z.HTMLAnchorElement);a&&(C=new URL(a.href,e.Z.location.origin))}else C=new URL(r.target.action,e.Z.location.origin);if(C&&C.origin===e.Z.location.origin){const a=q(C);a&&(r.preventDefault(),(0,m.WI)(L,"navigate",{bubbles:!0,detail:{entry:a,url:C}}))}}let y1;function L1(r,C){r.preventDefault(),y1=C;const a=r.composedPath(),d={type:r.type,ctrlKey:r.ctrlKey,metaKey:r.metaKey,target:r.target,defaultPrevented:!1,preventDefault:()=>{},composedPath:()=>a};return C.then(()=>{C===y1&&(c1(d),y1=null)})}function O1(r,C,a){let d=x.get(r);const _=[];for(const[P,B]of C.entries())(P===0||C[P-1].id!==B.id||a1(B.id).multiple)&&_.push(B);const u=d.length-_.length;d=_.map((P,B)=>{const R=d[B+u],W=a1(P.id);let F;if(R){const p1=g.get(R);if(W.id!==p1.id||B===0&&W.replace)return W.create();F=R}else F=W.create();return F}),x.set(r,d);const $=d[0],j=N.get($);for(const[P,B]of Object.entries(C[0].params))P in $&&($[P]=B);for(const P of a.params)P in $&&($[P]=r[P]);return j&&j(),d}function A1(r){const C=[];for(let[_,u]of e.Z.history.state.entries()){let $=0;for(;u;)C[$]=C[$]||[],C[$][_]=u,u=u.nested,$+=1}let a=0,d=0;for(;r;){const _=a1(r.id);let u=a;for(;u<C[d].length;u+=1){const $=C[d][u];if(_.dialog)return $.id!==r.id?-1:a;if($.id===r.id)if(_.multiple){if(_.pathnameParams&&_.pathnameParams.every(P=>r.params[P]===$.params[P])||Object.entries(r.params).every(([P,B])=>$.params[P]===B)){a=u;break}}else{a=u;break}const j=a1($.id);if(Q(j,_)){if(_.multiple&&C[d][0].id===r.id){a-=1;break}if(u>0){a=u-1;break}else return j.guard?0:-1}}u===C[d].length&&(a=C[d].length-1),r=r.nested,d+=1}return a}function P1(r,C,a){function d(){const R=O1(r,e.Z.history.state,a);C();const W=R[0];g.get(W).dialog||K(W)}function _(R,W,F){const p1=e.Z.history.state,M1=e.Z.history.state[R],D=R<p1.length-1&&p1.length>2?1:0;R+=D,M1&&W.id===M1.id&&(W={...M1,...W});const n1=r1=>{r1&&(e.Z.removeEventListener("popstate",n1),e.Z.addEventListener("popstate",d));const o=D?"pushState":"replaceState",t=[W,...p1.slice(R+(D?0:1))];e.Z.history[o](t,"",F),d()};R?(e.Z.removeEventListener("popstate",d),e.Z.addEventListener("popstate",n1),e.Z.history.go(-R)):n1()}function u(R){const W=e.Z.history.state;let F=R;for(;F.nested;)F=F.nested;const p1=a1(F.id),M1=p1.browserUrl?p1.url(F.params,!0):a.url,D=A1(R);if(D>-1)_(D,R,M1);else{let n1=x.get(r);h1(n1[0]),e.Z.history.scrollRestoration="manual",e.Z.history.pushState([R,...W],"",M1),d()}}function $(R){u(R.detail.entry)}if(L)throw Error(`An element with root router already connected to the document: <${L.tagName.toLowerCase()}>`);let j;try{j=d1(a.views,a),L=r,N.set(r,d)}catch(R){throw console.error(`Error while connecting router in <${r.tagName.toLowerCase()}>:`),R}const P=e.Z.history.state,B=new URL(e.Z.location.href);if(P){const R=x.get(r);let W;for(W=P.length-1;W>=0;W-=1){let F=P[W];for(;F;){const p1=a1(F.id);if(!p1||p1.dialog&&R.length===0||!j.includes(p1)&&!j.some(M1=>Q(M1,p1)))break;F=F.nested}if(F)break}if(W>-1){const F=P[W+1];_(P.length-W-1,F||j[0].getEntry(P[0].params),a.url)}else{let F=P[0];for(;F.nested;)F=F.nested;const M1=a1(F.id).getEntry(F.params);u(M1)}}else{const R=q(B)||j[0].getEntry();e.Z.history.replaceState([R],"",a.url),d()}return e.Z.addEventListener("popstate",d),r.addEventListener("click",c1),r.addEventListener("submit",c1),r.addEventListener("navigate",$),()=>{e.Z.removeEventListener("popstate",d),r.removeEventListener("click",c1),r.removeEventListener("submit",c1),r.removeEventListener("navigate",$),k.clear(),L=null;const R=e.Z.history.state&&e.Z.history.state.length;R>1&&(e.Z.history.go(1-R),e.Z.history.replaceState(P,"",B))}}function D1(r,C,a){const d=g.get(r);function _(){return e.Z.history.state.map($=>{for(;$;){if($.id===d.id)return $.nested;$=$.nested}return $}).filter($=>$)}function u(){O1(r,_(),a),C()}if(!_()[0]){const $=e.Z.history.state;e.Z.history.replaceState([d.nestedRoots[0].getEntry($[0].params),...$.slice(1)],"")}u(),N.set(r,u)}function j1(r,C){C={url:e.Z.location.href.replace(/#.*$/,""),params:[],...C,views:r};const a={get:d=>{const _=x.get(d)||[];return _.slice(0,_.findIndex(u=>!g.get(u).dialog)+1).reverse()},connect:(d,_,u)=>{for(const $ of C.params)if(!($ in d))throw Error(`Property '${$}' for global parameters is not defined in <${d.tagName.toLowerCase()}>`);return x.has(d)||x.set(d,[]),g.has(d)?D1(d,u,C):P1(d,u,C)},observe:A&&((d,_,u)=>{const $=_.length-1,j=_[$];if(u&&j===u[$])return;let P=g.get(d),B=e.Z.history.state[0],R=0;for(;P;)R+=1,B=B.nested,P=P.nestedParent;console.groupCollapsed(`[${d.tagName.toLowerCase()}]: navigated to <${B.id}> ($$${R})`);for(const[W,F]of Object.entries(B.params))console.log(`%c${W}:`,"font-weight: bold",F);console.groupEnd(),e.Z[`$$${R}`]=j})};return H.set(a,C),a}const B1=Object.freeze(Object.assign(j1,{connect:V,debug:i1,url:f,backUrl:E,guardUrl:c,currentUrl:p,resolve:L1,active:o1}))},56400:(I,v,s)=>{"use strict";s.d(v,{MY:()=>D,dy:()=>n1,YP:()=>r1});var e={};s.r(e),s.d(e,{resolve:()=>P,set:()=>$});var i=s(80004),m=s(77540),V=s(67132);const g=!!i.Z.document.adoptedStyleSheets,N=/^\d+$/,x={block:(o,t)=>({display:"block","text-align":t}),inline:({display:o})=>({display:`inline${o?`-${o}`:""}`}),contents:{display:"contents"},hidden:{display:"none"},...["row","row-reverse","column","column-reverse"].reduce((o,t)=>(o[t]=(n,l="nowrap")=>({display:"flex","flex-flow":`${t} ${l}`}),o),{}),grow:(o,t=1)=>({"flex-grow":t}),shrink:(o,t=1)=>({"flex-shrink":t}),basis:(o,t)=>({"flex-basis":k(t)}),order:(o,t=0)=>({order:t}),grid:(o,t="1",n="",l="",M="")=>({display:"grid",...["columns","rows"].reduce((h,T)=>{const S=T==="columns"?t:n;return h[`grid-template-${T}`]=S&&S.split("|").map(g1=>g1.match(N)?`repeat(${g1}, minmax(0, 1fr))`:k(g1)).join(" "),h},{}),"grid-auto-flow":`${l} ${M&&"dense"}`}),area:(o,t="",n="")=>({"grid-column":t.match(N)?`span ${t}`:t,"grid-row":n.match(N)?`span ${n}`:n}),gap:(o,t=1,n="")=>({"column-gap":k(t),"row-gap":k(n||t)}),items:(o,t="start",n="")=>({"place-items":`${t} ${n}`}),content:(o,t="start",n="")=>({"place-content":`${t} ${n}`}),self:(o,t="start",n="")=>({"place-self":`${t} ${n}`}),center:{"place-items":"center","place-content":"center"},size:(o,t,n=t)=>({width:k(t),height:k(n),"box-sizing":"border-box"}),width:(o,t,n,l)=>({width:k(t),"min-width":k(n),"max-width":k(l),"box-sizing":"border-box"}),height:(o,t,n,l)=>({height:k(t),"min-height":k(n),"max-height":k(l),"box-sizing":"border-box"}),ratio:(o,t)=>({"aspect-ratio":t}),overflow:(o,t="hidden",n="")=>{const l=n?`-${t}`:"",M=n||t;return{[`overflow${l}`]:M,...M==="scroll"?{"flex-grow":o["flex-grow"]||1,"flex-basis":0,"overscroll-behavior":"contain","--webkit-overflow-scrolling":"touch"}:{}}},margin:(o,t="1",n,l,M)=>t.match(/top|bottom|left|right/)?{[`margin-${t}`]:k(n||"1")}:{margin:`${k(t)} ${k(n)} ${k(l)} ${k(M)}`},padding:(o,t="1",n,l,M)=>t.match(/top|bottom|left|right/)?{[`padding-${t}`]:k(n||"1")}:{padding:`${k(t)} ${k(n)} ${k(l)} ${k(M)}`},absolute:{position:"absolute"},relative:{position:"relative"},fixed:{position:"fixed"},sticky:{position:"sticky"},static:{position:"static"},inset:(o,t=0)=>{const n=k(t);return{top:n,right:n,bottom:n,left:n}},top:(o,t=0)=>({top:k(t)}),bottom:(o,t=0)=>({bottom:k(t)}),left:(o,t=0)=>({left:k(t)}),right:(o,t=0)=>({right:k(t)}),layer:(o,t=1)=>({"z-index":t})},H={min:"min-content",max:"max-content",fit:"fit-content",full:"100%"},L={portrait:"orientation: portrait",landscape:"orientation: landscape"};function k(o){return o=H[o]||o,/^-?\d+(\.\d+)*$/.test(String(o))?`${o*8}px`:o||""}let A;function i1(){if(A)return A;if(g)A=new i.Z.CSSStyleSheet;else{const o=i.Z.document.createElement("style");o.appendChild(i.Z.document.createTextNode("")),i.Z.document.head.appendChild(o),A=o.sheet}return A.insertRule(":host([hidden]) { display: none; }"),A}const l1=new WeakMap;let t1=new WeakSet;function h1(o){const t=o.getRootNode();if(t1.has(t))return;const n=i1();if(g)t.adoptedStyleSheets=[...t.adoptedStyleSheets,n];else{if(t===i.Z.document)return;let l=l1.get(t);l||(l=i.Z.document.createElement("style"),t.appendChild(l),l1.set(t,l));let M="";for(let h=0;h<n.cssRules.length;h++)M+=n.cssRules[h].cssText;l.textContent=M}t1.add(t)}const O=new Map;function K(o,t,n,l){let M=O.get(o);M||(M=`l-${Math.random().toString(36).substr(2,5)}`,O.set(o,M)),g||(t1=new WeakSet);const h=i1(),[T,S=""]=t.split("@"),g1=Object.entries(n.replace(/\s+/g," ").trim().split(" ").reduce((G,X)=>{const[u1,...H1]=X.split(":"),U=x[u1];if(!U)throw TypeError(`Unsupported layout rule: '${u1}'`);return Object.assign(G,typeof U=="function"?U(G,...H1.map(e1=>e1.match(/--.*/)?`var(${e1})`:e1)):U)},{})).reduce((G,[X,u1])=>u1!==void 0&&u1!==""?G+`${X}: ${u1};`:G,""),k1=S.split(":").reduce((G,X)=>X===""?G:G+` and (${L[X]||`min-width: ${X}`})`,"@media screen");if(l){const G=`:host(.${M}-s${T})`,X=`:where(.${M}-c${T})`;[G,X].forEach(u1=>{h.insertRule(S?`${k1} { ${u1} { ${g1} } }`:`${u1} { ${g1} }`,h.cssRules.length-1)})}else{const G=`.${M}${T}`;h.insertRule(S?`${k1} { ${G} { ${g1} } }`:`${G} { ${g1} }`,h.cssRules.length-1)}return M}var y=s(58768);const b=new WeakMap;function z(o,t){const n=(0,y.xZ)(o),l=n.startNode,M=(0,y.cc)(n.endNode);t.parentNode.insertBefore(o,t.nextSibling);let h=o,T=l;for(;T;){const S=T.nextSibling;h.parentNode.insertBefore(T,h.nextSibling),h=T,T=S!==M.nextSibling&&S}}function Q(o,t,n,l,M){let h=b.get(t);const T=n.map((G,X)=>({id:hasOwnProperty.call(G,"id")?G.id:X,value:G,placeholder:null,available:!0}));if(b.set(t,T),h){const G=new Set;for(const X of T)G.add(X.id);h=h.filter(X=>G.has(X.id)?!0:((0,y.CK)(X.placeholder),X.placeholder.parentNode.removeChild(X.placeholder),!1))}let S=t;const g1=n.length-1,k1=(0,y.xZ)(t);for(let G=0;G<T.length;G+=1){const X=T[G];let u1;if(h){for(let H1=0;H1<h.length;H1+=1)if(h[H1].available&&h[H1].id===X.id){u1=h[H1];break}}u1?(u1.available=!1,X.placeholder=u1.placeholder,X.placeholder.previousSibling!==S&&z(X.placeholder,S),u1.value!==X.value&&l(o,X.placeholder,X.value,u1.value,M)):(X.placeholder=i.Z.document.createTextNode(""),S.parentNode.insertBefore(X.placeholder,S.nextSibling),l(o,X.placeholder,X.value,void 0,M)),S=(0,y.cc)((0,y.xZ)(X.placeholder,{}).endNode||X.placeholder),G===0&&(k1.startNode=X.placeholder),G===g1&&(k1.endNode=S)}if(h)for(const G of h)G.available&&((0,y.CK)(G.placeholder),G.placeholder.parentNode.removeChild(G.placeholder))}function J(o,t,n){(0,y.CK)(t);const l=(0,y.xZ)(t);l.startNode=l.endNode=n,t.parentNode.insertBefore(n,t.nextSibling)}function d1(o){const t=typeof o;if(t==="object"){if(Array.isArray(o))return"array";if(o instanceof i.Z.Node)return"node"}return t}function C1(o,t,n,l,M){const h=d1(n),T=d1(l);switch(T!=="undefined"&&h!==T&&(h!=="function"&&(0,y.CK)(t),T==="array"?b.delete(t):T!=="node"&&T!=="function"&&(t.textContent="")),h){case"array":Q(o,t,n,C1,M);break;case"node":J(o,t,n);break;case"function":M&&(n.useLayout=!0),n(o,t);break;default:t.textContent=h==="number"||n?n:""}}const a1=new WeakMap;function w(o){return(t,n,l,M)=>{if(M){const h=a1.get(n);h&&n.removeEventListener(o,h.get(M),M.options!==void 0?M.options:!1)}if(l){if(typeof l!="function")throw Error(`Event listener must be a function: ${typeof l}`);let h=a1.get(n);h||(h=new WeakMap,a1.set(n,h));const T=l.bind(null,t);h.set(l,T),n.addEventListener(o,T,l.options!==void 0?l.options:!1)}}}function f(o,t=new Set){if(Array.isArray(o))for(const n of o)n&&t.add(n);else if(o!==null&&typeof o=="object")for(const[n,l]of Object.entries(o))n&&l&&t.add(n);else o&&t.add(o);return t}const Z=new WeakMap;function E(o,t,n){const l=Z.get(t)||new Set,M=f(n);Z.set(t,M);for(const h of M)t.classList.add(h),l.delete(h);for(const h of l)t.classList.remove(h)}const c=new WeakMap;function p(o,t,n){if(n===null||typeof n!="object")throw TypeError(`Style value must be an object in ${(0,m.r4)(t)}:`,n);const l=c.get(t)||new Map,M=new Map;for(const h of Object.keys(n)){const T=(0,m.Dk)(h),S=n[h];!S&&S!==0?t.style.removeProperty(T):t.style.setProperty(T,S),M.set(T,S),l.delete(T)}for(const h of l.keys())t.style[h]="";c.set(t,M)}function o1(o,t,n){if(t.substr(0,2)==="on"){const l=t.substr(2);return w(l)}switch(o){case"class":return E;case"style":return p;default:{let l=!1;return(M,h,T)=>{if(l=l||!n&&!(h instanceof i.Z.SVGElement)&&t in h,l)h[t]=T;else if(T===!1||T===void 0||T===null)h.removeAttribute(o);else{const S=T===!0?"":String(T);h.setAttribute(o,S)}}}}}const q=(0,y.ph)("(\\d+)"),c1=new RegExp(`^${q}$`),y1=new RegExp(q,"g"),L1=/^[^A-Za-z]+$/;function O1(o){let t=o[0],n=!1;for(let l=1;l<o.length;l+=1)n=n||o[l-1].match(/<\s*(table|tr|thead|tbody|tfoot|colgroup)([^<>]|"[^"]*"|'[^']*')*>\s*$/),t+=(n?`<!--${(0,y.ph)(l-1)}-->`:(0,y.ph)(l-1))+o[l],n=n&&!o[l].match(/<\/\s*(table|tr|thead|tbody|tfoot|colgroup)\s*>/);return t}function A1(o){return o.replace(/\s*=\s*['"]*$/g,"").split(/\s+/).pop()}function P1(o){return i.Z.document.createTreeWalker(o,i.Z.NodeFilter.SHOW_ELEMENT|i.Z.NodeFilter.SHOW_TEXT|i.Z.NodeFilter.SHOW_COMMENT,null,!1)}function D1(o,t=0){o=o.replace(/(^[\n\s\t ]+)|([\n\s\t ]+$)+/g,"");let n=o.indexOf(`
`);if(n>-1){let l=0-t-2;for(n+=1;o[n]===" "&&n<o.length;n+=1)l+=1;return o.replace(/\n +/g,M=>M.substr(0,Math.max(M.length-l,1)))}return o}function j1(o,t){const n=(0,y.ph)(t);return`${D1(o).split(`
`).filter(M=>M).map(M=>{const h=M.indexOf(n);return h>-1?`| ${M}
--${"-".repeat(h)}${"^".repeat(6)}`:`| ${M}`}).join(`
`).replace(y1,"${...}")}`}const B1=new Map,r=new WeakMap;function C(o){if(o.adoptedStyleSheets)return n=>{const l=r.get(o),M=n&&n.map(T=>{let S=T;return S instanceof i.Z.CSSStyleSheet||(S=B1.get(T),S||(S=new i.Z.CSSStyleSheet,S.replaceSync(T),B1.set(T,S))),S});let h;if(l){if(M&&M.length===l.length&&M.every((T,S)=>T===l[S]))return;h=o.adoptedStyleSheets.filter(T=>!l.includes(T))}M&&(h=(h||o.adoptedStyleSheets).concat(M)),h&&(o.adoptedStyleSheets=h),r.set(o,M)};let t;return n=>{if(n){t||(t=i.Z.document.createElement("style"),o=(0,y.cc)(o),o.nodeType===i.Z.Node.TEXT_NODE?o.parentNode.insertBefore(t,o.nextSibling):o.appendChild(t));const l=[...n].join(`
/*------*/
`);t.textContent!==l&&(t.textContent=l)}else t&&(t.parentNode.removeChild(t),t=null)}}function a(o,t,n,l){let M=i.Z.document.createElement("template");const h={},T=n?o:O1(o);if(M.innerHTML=t?`<svg>${T}</svg>`:T,t){const U=M.content.firstChild;M.content.removeChild(U);for(const e1 of Array.from(U.childNodes))M.content.appendChild(e1)}let S;const g1=M.content.children[0];if(g1 instanceof i.Z.HTMLTemplateElement){for(const U of Array.from(g1.attributes)){const e1=U.value.trim();if(U.name.startsWith("layout")&&e1){if(e1.match(y1))throw Error("Layout attribute cannot contain expressions");S=K(g1,U.name.substr(6),e1,!0)}}if(S!==void 0&&M.content.children.length>1)throw Error("Template, which uses layout system must have only the '<template>' root element");l=!0,M=g1}const k1=P1(M.content),G=[];let X=0,u1=null;for(;k1.nextNode();){let U=k1.currentNode;if(u1&&!u1.contains(U)&&(u1=null),U.nodeType===i.Z.Node.COMMENT_NODE&&c1.test(U.textContent)&&(U.parentNode.insertBefore(i.Z.document.createTextNode(U.textContent),U.nextSibling),k1.nextNode(),U.parentNode.removeChild(U),U=k1.currentNode),U.nodeType===i.Z.Node.TEXT_NODE){let e1=U.textContent;const w1=e1.match(c1);if(w1)U.textContent="",h[w1[1]]=[X,C1];else{if((0,V.eL)()&&!n&&!u1&&!e1.match(/^\s*$/)){let m1;const Y=e1.trim(),s1=Y.replace(/\s+/g," ").replace(y1,(f1,v1)=>(v1=Number(v1),m1===void 0&&(m1=v1),`\${${v1-m1}}`));if(!s1.match(L1)){let f1=U.previousSibling&&U.previousSibling.nodeType===i.Z.Node.COMMENT_NODE?U.previousSibling:"";f1&&(f1.parentNode.removeChild(f1),X-=1,f1=(f1.textContent.split("|")[1]||"").trim().replace(/\s+/g," "));const v1=(0,V.U2)(s1,f1).replace(/\${(\d+)}/g,(_1,V1)=>(0,y.ph)(Number(V1)+m1));e1=e1.replace(Y,v1),U.textContent=e1}}const x1=e1.match(y1);if(x1){let m1=U;x1.reduce((Y,s1)=>{const[f1,v1]=Y.pop().split(s1);return f1&&Y.push(f1),Y.push(s1),v1&&Y.push(v1),Y},[e1]).forEach((Y,s1)=>{s1===0?m1.textContent=Y:(m1=m1.parentNode.insertBefore(i.Z.document.createTextNode(Y),m1.nextSibling),k1.currentNode=m1,X+=1);const f1=m1.textContent.match(c1);f1&&(m1.textContent="",h[f1[1]]=[X,C1])})}}}else if(U.nodeType===i.Z.Node.ELEMENT_NODE){if(!u1&&(U.getAttribute("translate")==="no"||U.tagName.toLowerCase()==="script"||U.tagName.toLowerCase()==="style")&&(u1=U),m.$H){const e1=U.tagName.toLowerCase();e1.match(/.+-.+/)&&!i.Z.customElements.get(e1)&&!G.includes(e1)&&G.push(e1)}for(const e1 of Array.from(U.attributes)){const w1=e1.value.trim(),x1=e1.name;if(l&&x1.startsWith("layout")&&w1){if(w1.match(y1))throw Error("Layout attribute cannot contain expressions");const Y=K(U,x1.substr(6),w1);U.removeAttribute(x1),U.classList.add(Y);continue}const m1=w1.match(c1);if(m1){const Y=A1(o[m1[1]]);h[m1[1]]=[X,o1(x1,Y,t)],U.removeAttribute(e1.name)}else{const Y=w1.match(y1);if(Y){const s1=`attr__${x1}`;for(const[f1,v1]of Y.entries()){const[,_1]=v1.match(c1);let V1=!1;h[_1]=[X,($1,E1,Z1)=>{const T1=(0,y.xZ)(E1);T1[s1]=(T1[s1]||w1).replace(v1,Z1==null?"":Z1),(Y.length===1||f1+1===Y.length)&&(V1=V1||!t&&!(E1 instanceof i.Z.SVGElement)&&x1 in E1,V1?E1[x1]=T1[s1]:E1.setAttribute(x1,T1[s1]),T1[s1]=void 0)}]}e1.value=""}}}}X+=1}m.$H&&G.length&&console.warn(`Not defined ${G.map(U=>`<${U}>`).join(", ")} element${G.length>1?"s":""} found in the template:
${j1(T,-1)}`);const H1=Object.keys(h);return function(e1,w1,x1,m1){let Y=(0,y.xZ)(w1);if(M!==Y.template){const s1=i.Z.document.importNode(M.content,!0),f1=P1(s1),v1=[];let _1=0,V1=0,$1=h[H1[V1]];for(;f1.nextNode();){const E1=f1.currentNode;for(;$1&&$1[0]===_1;)v1.push({index:H1[V1],node:E1,fn:$1[1]}),V1+=1,$1=h[H1[V1]];_1+=1}if(Y.hostLayout&&e1.classList.remove(Y.hostLayout),(0,y.CK)(w1),Y=(0,y.xZ)(w1),Y.template=M,Y.markers=v1,Y.styles=C(w1),w1.nodeType===i.Z.Node.TEXT_NODE){Y.startNode=s1.childNodes[0],Y.endNode=s1.childNodes[s1.childNodes.length-1];let E1=w1,Z1=s1.childNodes[0];for(;Z1;)w1.parentNode.insertBefore(Z1,E1.nextSibling),E1=Z1,Z1=s1.childNodes[0]}else{if(l){const E1=`${S}-${e1===w1?"c":"s"}`;e1.classList.add(E1),Y.hostLayout=E1}w1.appendChild(s1)}l&&h1(w1)}Y.styles(m1);for(const s1 of Y.markers){const f1=x1[s1.index],v1=Y.prevArgs&&Y.prevArgs[s1.index];if(!(Y.prevArgs&&f1===v1))try{s1.fn(e1,s1.node,f1,v1,l)}catch(_1){throw console.error(`Following error was thrown when updating a template expression in ${(0,m.r4)(e1)}
${j1(T,s1.index)}`),_1}}Y.prevArgs=x1}}function d({target:o,detail:t},n){let l;switch(o.type){case"radio":case"checkbox":l=o.checked&&o.value;break;case"file":l=o.files;break;default:l=t&&hasOwnProperty.call(t,"value")?t.value:o.value}n(l)}function _(o,t){return o.split(".").reverse().reduce((n,l)=>n?{[l]:n}:{[l]:t},null)}const u=new Map;function $(o,t){if(!o)throw Error(`The first argument must be a property name or an object instance: ${o}`);if(typeof o=="object"){if(t===void 0)throw Error("For model instance property the second argument must be defined");const l=m.Qz.get(o);if(!l)throw Error("Provided object must be a model instance of the store");return t===null?()=>{l.set(o,null)}:(M,h)=>{d(h,T=>{l.set(o,_(t,T))})}}if(arguments.length===2)return l=>{l[o]=t};let n=u.get(o);return n||(n=(l,M)=>{d(M,h=>{l[o]=h})},u.set(o,n)),n}const j=new WeakMap;function P(o,t,n=200){return function l(M,h){const T=l.useLayout;let S;t&&(S=setTimeout(()=>{S=void 0,C1(M,h,t,void 0,T)},n)),j.set(h,o),o.then(g1=>{S&&clearTimeout(S),j.get(h)===o&&(C1(M,h,g1,t&&!S?t:void 0,T),j.set(h,null))})}}const B=(0,y.ph)(),R=(0,y.ph)("svg"),W=(0,y.ph)("msg"),F=(0,y.ph)("layout"),p1={key(o){return this.id=o,this},style(...o){return this.styleSheets=this.styleSheets||[],this.styleSheets.push(...o),this},css(o,...t){this.styleSheets=this.styleSheets||[];let n=o[0];for(let l=1;l<o.length;l++)n+=(t[l-1]!==void 0?t[l-1]:"")+o[l];return this.styleSheets.push(n),this}},M1=new Map;function D(o,t,n,l){function M(h,T=h){let S=l?o+W:o.join(B);n&&(S+=R);const g1=M.useLayout;g1&&(S+=F);let k1=M1.get(S);k1||(k1=a(o,n,l,g1),M1.set(S,k1)),k1(h,T,t,M.styleSheets)}return Object.assign(M,p1)}function n1(o,...t){return D(o,t,!1,!1)}function r1(o,...t){return D(o,t,!0,!1)}Object.freeze(Object.assign(n1,e))},58768:(I,v,s)=>{"use strict";s.d(v,{CK:()=>g,cc:()=>V,ph:()=>x,xZ:()=>m});var e=s(80004);const i=new WeakMap;function m(H){let L=i.get(H);return L||(i.set(H,L={}),L)}function V(H){let L;for(;H&&(L=m(H))&&L.endNode;)H=L.endNode;return H}function g(H){const L=m(H);if(L.styles&&L.styles(),H.nodeType===e.Z.Node.TEXT_NODE){if(L.startNode){const k=V(L.endNode);let A=L.startNode;const i1=k.nextSibling;for(;A;){const l1=A.nextSibling;A.parentNode.removeChild(A),A=l1!==i1&&l1}}}else{let k=H.childNodes[0];for(;k;)H.removeChild(k),k=H.childNodes[0]}i.delete(H)}const N=Date.now(),x=(H=0)=>`H-${N}-${H}`},77540:(I,v,s)=>{"use strict";s.d(v,{$H:()=>L,Dk:()=>m,N7:()=>N,Qz:()=>H,WI:()=>V,gX:()=>x,r4:()=>g});var e=s(80004);const i=new Map;function m(k){let A=i.get(k);return A===void 0&&(A=k.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase(),i.set(k,A)),A}function V(k,A,i1={}){return k.dispatchEvent(new e.Z.CustomEvent(A,{bubbles:!1,...i1}))}function g(k){return`<${String(k.tagName).toLowerCase()}>`}function N(k,A){k.nodeType===e.Z.Node.ELEMENT_NODE&&(A(k),k.shadowRoot&&N(k.shadowRoot,A));const i1=e.Z.document.createTreeWalker(k,e.Z.NodeFilter.SHOW_ELEMENT,null,!1);for(;i1.nextNode();){const l1=i1.currentNode;A(l1),l1.shadowRoot&&N(l1.shadowRoot,A)}}const x=Promise.resolve(),H=new WeakMap,L=N.name==="walkInShadow"}},S1={};function b1(I){var v=S1[I];if(v!==void 0)return v.exports;var s=S1[I]={exports:{}};return N1[I](s,s.exports,b1),s.exports}b1.d=(I,v)=>{for(var s in v)b1.o(v,s)&&!b1.o(I,s)&&Object.defineProperty(I,s,{enumerable:!0,get:v[s]})},b1.o=(I,v)=>Object.prototype.hasOwnProperty.call(I,v),b1.r=I=>{typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(I,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(I,"__esModule",{value:!0})};var R1={};(()=>{"use strict";var I=b1(80004),v=b1(96806),s=b1(17337),e=b1(77540);function i(w,f){return{get:f?Z=>{const E=w(Z),c=Z.shadowRoot||Z.attachShadow({mode:"open",delegatesFocus:w.delegatesFocus||!1});return()=>(E(Z,c),c)}:Z=>{const E=w(Z);return()=>(E(Z,Z),Z)},observe(Z,E){E()}}}function m(w,f){const Z=w.value;return{get:(E,c)=>c===void 0?E.getAttribute(f)||Z:c,set:(E,c)=>(c=String(c),c?E.setAttribute(f,c):E.removeAttribute(f),c),connect:Z!==""?(E,c,p)=>(!E.hasAttribute(f)&&E[c]===Z&&E.setAttribute(f,Z),w.connect&&w.connect(E,c,p)):w.connect,observe:w.observe}}function V(w,f){const Z=w.value;return{get:(E,c)=>c===void 0?Number(E.getAttribute(f)||Z):c,set:(E,c)=>(c=Number(c),E.setAttribute(f,c),c),connect:(E,c,p)=>(!E.hasAttribute(f)&&E[c]===Z&&E.setAttribute(f,Z),w.connect&&w.connect(E,c,p)),observe:w.observe}}function g(w,f){const Z=w.value;return{get:(E,c)=>c===void 0?E.hasAttribute(f)||Z:c,set:(E,c)=>(c=Boolean(c),c?E.setAttribute(f,""):E.removeAttribute(f),c),connect:Z===!0?(E,c,p)=>(!E.hasAttribute(f)&&E[c]===Z&&E.setAttribute(f,""),w.connect&&w.connect(E,c,p)):w.connect,observe:w.observe}}function N(w,f){const Z=w.value;return{get:(E,c)=>c===void 0?E.getAttribute(f)||Z:c,set:(E,c)=>c,connect:w.connect,observe:w.observe}}function x(w,f){const Z=typeof f.value,E=(0,e.Dk)(w);switch(Z){case"string":return m(f,E);case"number":return V(f,E);case"boolean":return g(f,E);case"undefined":return N(f,E);default:throw TypeError(`Invalid default value for '${w}' property - it must be a string, number, boolean or undefined: ${Z}`)}}const H=new WeakMap;function L(w,f){if(f){if(w===f.hybrids)return f;for(const c of Object.keys(f.hybrids))delete f.prototype[c]}else f=class extends I.Z.HTMLElement{connectedCallback(){for(const p of Object.keys(this)){const o1=this[p];delete this[p],this[p]=o1}const c=new Set;H.set(this,c),s.I(()=>{if(c===H.get(this)){for(const p of this.constructor.connects)c.add(p(this));for(const p of this.constructor.observers)c.add(p(this))}})}disconnectedCallback(){const c=H.get(this);for(const p of c)p&&p();H.delete(this),v.NE(this)}};f.hybrids=w;const Z=new Set,E=new Set;for(const c of Object.keys(w)){if(c==="tag")continue;let p=w[c];const o1=typeof p;if(o1==="function")c==="render"?p=i(p,!0):c==="content"?p=i(p):p={get:p};else if(o1!=="object"||p===null)p={value:p};else if(p.set){if(hasOwnProperty.call(p,"value"))throw TypeError(`Invalid property descriptor for '${c}' property - it must not have 'value' and 'set' properties at the same time.`);const q=(0,e.Dk)(c),c1=p.get||((y1,L1)=>L1);p.get=(y1,L1)=>(L1===void 0&&(L1=p.set(y1,y1.getAttribute(q)||L1)),c1(y1,L1))}if(hasOwnProperty.call(p,"value"))p=x(c,p);else if(!p.get)throw TypeError(`Invalid descriptor for '${c}' property - it must contain 'value' or 'get' option`);Object.defineProperty(f.prototype,c,{get:function(){return v.U2(this,c,p.get)},set:p.set&&function(c1){v.t8(this,c,p.set,c1)},enumerable:!0,configurable:!0}),p.connect&&Z.add(q=>p.connect(q,c,()=>{v.z6(q,c)})),p.observe&&E.add(q=>v.N7(q,c,p.get,p.observe))}return f.connects=Z,f.observers=E,f}const k=new Map;function A(w){k.size||e.gX.then(()=>{(0,e.N7)(I.Z.document.body,f=>{if(k.has(f.constructor)){const Z=k.get(f.constructor),E=f.constructor.hybrids;f.disconnectedCallback();for(const c of Object.keys(E)){const p=typeof E[c],o1=p!=="object"&&p!=="function"&&E[c]!==Z[c];v.z6(f,c,{clearValue:o1})}f.connectedCallback()}}),k.clear()}),k.set(w,w.hybrids)}function i1(w){if(!w.tag)throw TypeError("Error while defining hybrids: 'tag' property with dashed tag name is required");const f=I.Z.customElements.get(w.tag);if(f){if(f.hybrids)return A(f),L(w,f),Object.freeze(w);throw TypeError(`Custom element with '${w.tag}' tag name already defined outside of the hybrids context`)}return I.Z.customElements.define(w.tag,L(w)),Object.freeze(w)}function l1(w,f={}){const{root:Z="",prefix:E}=f,c=Object.keys(w);if(c.length===0)return w;for(const p of c){const o1=w[p];if(!o1.tag){const q=(0,e.Dk)([].concat(Z).reduce((c1,y1)=>c1.replace(y1,""),p).replace(/^[./]+/,"").replace(/\//g,"-").replace(/\.[a-zA-Z]+$/,""));o1.tag=E?`${E}-${q}`:q}i1(o1)}return w}const t1=Object.freeze(Object.assign(i1,{compile:w=>L(w),from:l1}));var h1=b1(56400),O=b1(9664);t1.from(function(){const w=[],f=[];var Z=function(){const E=b1(23998),c={};return E.keys().forEach(function(p){const o1="./components/"+p.replace("./","");!w.includes(o1)&&!f.includes(o1)&&(f.push(o1),c[o1]=function(){const q=E(p);return Object.prototype.toString.call(q)==="[object Module]",q.default}())}),c}();return Object.assign(Z)}(),{prefix:"ui",root:"components"}),t1.from(function(){const w=[],f=[];var Z=function(){const c=b1(86782),p={};return c.keys().forEach(function(o1){const q="./components/"+o1.replace("./","");!w.includes(q)&&!f.includes(q)&&(f.push(q),p[q]=function(){const c1=c(o1);return Object.prototype.toString.call(c1)==="[object Module]",c1.default}())}),p}(),E=function(){const c=b1(72782),p={};return c.keys().forEach(function(o1){const q="./views/"+o1.replace("./","");!w.includes(q)&&!f.includes(q)&&(f.push(q),p[q]=function(){const c1=c(o1);return Object.prototype.toString.call(c1)==="[object Module]",c1.default}())}),p}();return Object.assign(Z,E)}(),{prefix:"ui-autoconsent",root:["components"]});function K(w){const f=document.createElement("ghostery-iframe-wrapper"),Z=f.attachShadow({mode:"closed"}),E=document.createElement("template");E.innerHTML=`
    <iframe src="${w}" frameborder="0"></iframe>
    <style>
      :host {
        all: initial;
  ...
  `,Z.appendChild(E.content),document.documentElement.appendChild(f);const c=Z.querySelector("iframe");setTimeout(()=>{c.classList.add("active")},100),window.addEventListener("message",p=>{var o1;switch((o1=p.data)==null?void 0:o1.type){case"ghostery-resize-iframe":c.style.width=p.data.width+"px",c.style.height=p.data.height+"px";break;case"ghostery-close-iframe":p.data.reload?window.location.reload():setTimeout(()=>f.parentElement.removeChild(f),0);break;default:break}})}function y(w=!1){window.parent.postMessage({type:"ghostery-close-iframe",reload:w},"*")}function b({width:w,height:f}={}){w&&(document.body.style.width=w+"px"),f&&(document.body.style.height=f+"px"),new ResizeObserver(()=>{window.parent.postMessage({type:"ghostery-resize-iframe",width:document.body.clientWidth,height:document.body.clientHeight},"*")}).observe(document.body,{box:"border-box"})}const z=new URLSearchParams(window.location.search).get("host");b();async function Q(w,f){const{all:Z}=f.detail;chrome.runtime.sendMessage({name:"enable",origin:"autoconsent",message:{url:Z?void 0:z}})}async function J(w,f){const{all:Z}=f.detail;chrome.runtime.sendMessage({name:"disable",origin:"autoconsent",message:{url:Z?void 0:z}})}function d1(w,f){y(f.detail.reload)}async function C1(){const w=await new Promise(p=>{chrome.runtime.sendMessage({name:"getTabInfo"},p)}),{summary:f}=await new Promise(p=>{chrome.runtime.sendMessage({name:"getPanelData",message:{view:"panel",tabId:w.id}},p)}),{antiTracking:Z,adBlock:E}=await new Promise(p=>{chrome.runtime.sendMessage({name:"getCommonModuleData",message:{tabId:w.id}},p)}),c=f.categories.reduce((p,o1)=>{for(let q=0;q<o1.num_total;q+=1)p.push(o1.id);return p},[]);for(let p=0;p<E.unidentifiedTrackerCount;p+=1)c.push("unknown");for(let p=0;p<Z.trackerCount;p+=1)c.push("advertising");return c}const a1=t1({tag:"gh-autoconsent",categories:{value:void 0,connect:(w,f)=>{let Z;const E=async()=>{w[f]=await C1(),Z=setTimeout(E,1e3)};return Z=setTimeout(E,1e3),()=>clearTimeout(Z)}},content:({categories:w})=>h1.dy`
